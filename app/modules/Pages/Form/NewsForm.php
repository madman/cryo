...
class NewsForm extends PageForm
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (isset($options['data']) && $options['data']->getImage() !== null) {
            $builder->add('image', new UploadedImageType(), ['label' => $this->app->trans('Изображения'), 'attr' => ['src' => CORE_UPLOADS_URL . '/news/' . $options['data']->getImage()]]);
        }
        ...
        $builder
            ...
            ->add('show_at', 'text', [
                'label' => $this->app->trans('Когда показать'),
